...
import {ERC20Borrowable, ERC20, Context} from "./ERC20Borrowable.sol";
...
contract ESynthFixed is ERC20Borrowable, Ownable {
    ...
    constructor(IEVC evc_, string memory name_, string memory symbol_)
        ERC20Borrowable(evc_, name_, symbol_)
        Ownable(msg.sender)
    {}
    ...
    function _msgSender() internal view virtual override (ERC20Borrowable, Context) returns (address) {
        return ERC20Borrowable._msgSender();
    }
